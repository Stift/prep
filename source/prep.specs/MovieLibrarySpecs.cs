...
namespace prep.specs
{
    ...
    public class MovieLibrarySpecs
    {
        ...
        public class when_sorting_movies : concern_for_searching_and_sorting
        {
            ...
            {
                var comparison = Sort<Movie>.by(x => x.title, SortOrders.ascending);
                var results = sut.all_movies().sort(comparison);
            ...
            {
                var comparison = Sort<Movie>.by(x => x.date_published, SortOrders.ascending);
                var results = sut.all_movies().sort(comparison);
            ...
            It should_be_able_to_sort_all_movies_by_studio_rating_and_year_published = () =>
            {
                ...
                //Universal
                //Disney
                var comparison = Sort<Movie>.by(x => x.production_studio,
